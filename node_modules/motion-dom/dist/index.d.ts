...
declare function calcGeneratorDuration<T>(generator: KeyframeGenerator<T>, timeStep?: number, maxDuration?: number, keyframes?: T[]): number;
...
declare class MotionValueState {
     ...
     */
    constructor(step?: Schedule);
    set(name: string, value: MotionValue, render?: VoidFunction, computed?: MotionValue, useDefaultValueType?: boolean): VoidFunction;
 ...
 */
type EffectRead<Subject extends object> = (subject: Subject, key: string, keyframes?: UnresolvedValueKeyframe | UnresolvedValueKeyframe[]) => AnyResolvedKeyframe | undefined;
interface EffectOptions<Subject extends object> {
 ...
 */
interface AnimateEffect<Subject extends object = object> extends Effect<Subject> {
    test: EffectTest<Subject>;
    read: EffectRead<Subject>;
}
...
declare function createEffect<Subject extends object>(addValue: AddEffectValue<Subject>, options: EffectOptions<Subject> & {
    test: EffectTest<Subject>;
    read: EffectRead<Subject>;
...
declare function findEffect(subject: unknown): AnimateEffect | undefined;
type EffectKeyframes = Record<string, UnresolvedValueKeyframe | UnresolvedValueKeyframe[]>;
/**
 * Effect subjects can expose any key, so per-key transition overrides
 * are keyed by arbitrary strings.
 */
type EffectTransition = ValueAnimationTransition & Record<string, unknown>;
/**
 ...
 */
declare function animateEffectSubject<Subject extends object>(effect: AnimateEffect<Subject>, subject: Subject, keyframes: EffectKeyframes, transition?: EffectTransition): AnimationPlaybackControlsWithThen[];

declare const addAttrValue: (element: HTMLElement | SVGElement, state: MotionValueState, key: string, value: MotionValue) => VoidFunction;
...
declare const addStyleValue: (element: HTMLElement | SVGElement, state: MotionValueState, key: string, value: MotionValue) => VoidFunction;
